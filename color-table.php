...
<div class="row">
  <div class="divColor col-8"></div>
  <table cellspacing="0" cellpadding="0" width="100%" align="center" border="1" bordercolor="#f0f0f0" style="background:#fff;color:#000;">
    <thead>
      <tr>
        <th>顏色</th><th>色碼</th><th>顏色</th><th>色碼</th><th>顏色</th><th>色碼</th><th>顏色</th><th>色碼</th><th>顏色</th><th>色碼</th>
      </tr>
    </thead>
            <tbody>
                <tr>
 ...
 <script>
   $(function(){
     ...
     $(".divColor").append(list_color(colors)).addClass("text-center");
    ...
    function list_color(c){
      ...
      //$.each(c,function(i,v){
      //  ii += 1;
      //  tb += "<tr><td>" + ii + "</td><td><div id='co' style='background-color:" + v + ";width:50px;height:50px;'></div></td><td>" + v + "</td></tr>";
      //});
      tb += "</table>";
      return tb;
    }
